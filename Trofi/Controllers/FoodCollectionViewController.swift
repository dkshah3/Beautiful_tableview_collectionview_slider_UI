...
class AppStoreCollectionSectionHeaderView: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        backgroundColor = UIColor.init(colorLiteralRed: 55, green: 55, blue: 55, alpha: 0)
        ...
        button.leadingAnchor.constraint(greaterThanOrEqualTo: label.trailingAnchor, constant: 7.0).isActive = true
...
class AppStoreCollectionViewLayoutDemoViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        if let layout = collectionView?.collectionViewLayout as? CollectionViewShelfLayout {
            layout.sectionCellInset = UIEdgeInsets(top: 3.0, left: 3.0, bottom: 3.0, right: 3.0)
