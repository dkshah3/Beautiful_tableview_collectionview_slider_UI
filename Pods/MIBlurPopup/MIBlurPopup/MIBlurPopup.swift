...
open class MIBlurPopup: NSObject {
    ...
    public static var shared = MIBlurPopup()
    
    public var visualEffectBlurView = UIVisualEffectView()
    ...
    public func animatePresent(transitionContext: UIViewControllerContextTransitioning) {
        guard
