...
SWIFT_MODULE_NAMESPACE_PUSH("CollectionViewShelfLayout")
@class UIView;
@class NSCoder;
...
SWIFT_CLASS("_TtC25CollectionViewShelfLayout25CollectionViewShelfLayout")
@interface CollectionViewShelfLayout : UICollectionViewLayout
/// A height of each section header. Set this value to 0.0 if you don’t want section header views. Default is <em>0.0</em>
@property (nonatomic) CGFloat sectionHeaderHeight;
/// A height of each section footer. Set this value to 0.0 if you don’t want section footer views. Default is <em>0.0</em>
@property (nonatomic) CGFloat sectionFooterHeight;
/// An inset around the cell area in each section inset from section header and footer view and the collection view’s bounds. Default is <em>zero</em> on every sides.
@property (nonatomic) UIEdgeInsets sectionCellInset;
/// A size of each cells.
@property (nonatomic) CGSize cellSize;
/// Horizontal spacing between cells. Default value is <em>8.0</em>
@property (nonatomic) CGFloat spacing;
/// A header view of the collection view. Similar to table view’s <em>tableHeaderView</em>
@property (nonatomic, strong) IBOutlet UIView * _Nullable headerView;
/// A footer view of the collection view. Similar to table view’s <em>tableFooterView</em>
@property (nonatomic, strong) IBOutlet UIView * _Nullable footerView;
...
@interface CollectionViewShelfLayout (SWIFT_EXTENSION(CollectionViewShelfLayout)) <UIScrollViewDelegate>
