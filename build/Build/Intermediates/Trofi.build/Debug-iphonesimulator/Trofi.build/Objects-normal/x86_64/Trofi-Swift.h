...
SWIFT_CLASS("_TtC5Trofi35AppStoreCollectionSectionHeaderView")
@interface AppStoreCollectionSectionHeaderView : UICollectionReusableView
...
SWIFT_CLASS("_TtC5Trofi26AppStoreCollectionViewCell")
@interface AppStoreCollectionViewCell : UICollectionViewCell
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified appPriceLabel;
...
SWIFT_CLASS("_TtC5Trofi46AppStoreCollectionViewLayoutDemoViewController")
@interface AppStoreCollectionViewLayoutDemoViewController : UICollectionViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, strong) NSNumberFormatter * _Nonnull priceFormatter;
...
@interface AppStoreCollectionViewLayoutDemoViewController (SWIFT_EXTENSION(Trofi))
- (void)sectionHeaderViewDidTappedButton:(AppStoreCollectionSectionHeaderView * _Nonnull)view;
@end

@class SKStoreProductViewController;

@interface AppStoreCollectionViewLayoutDemoViewController (SWIFT_EXTENSION(Trofi)) <SKStoreProductViewControllerDelegate>
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified MealsLeft;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified priceRange;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified pickupIs;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified pickupFs;
- (void)awakeFromNib;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, copy) NSString * _Nonnull vendorLogos;
@property (nonatomic, copy) NSString * _Nonnull vendorNames;
@property (nonatomic, copy) NSString * _Nonnull foodTypes;
@property (nonatomic, copy) NSString * _Nonnull distances;
@property (nonatomic, copy) NSString * _Nonnull MealsLefts;
@property (nonatomic, copy) NSString * _Nonnull priceRanges;
@property (nonatomic, copy) NSString * _Nonnull pickupIss;
@property (nonatomic, copy) NSString * _Nonnull pickupFss;
...
SWIFT_CLASS("_TtC5Trofi19PopupViewController")
@interface PopupViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified dismissButton;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified popupContentContainerView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified popupMainView;
- (void)viewDidLoad;
- (IBAction)dismissButtonTapped:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface PopupViewController (SWIFT_EXTENSION(Trofi))
@property (nonatomic, readonly, strong) UIView * _Nonnull popupView;
@property (nonatomic, readonly) UIBlurEffectStyle blurEffectStyle;
@property (nonatomic, readonly) CGFloat initialScaleAmmount;
